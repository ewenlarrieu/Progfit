    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      >
        ...
        <header className="mb-8">
          ...
          <div className="bg-[#E22807] text-white px-4 sm:px-6 py-3 sm:py-4 rounded-lg w-fit font-semibold text-2xl sm:text-3xl md:text-4xl">
          ...
          <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 mt-6 w-full">
            {programmes.map((p, index) => (
              ...
              >
                ...
                <div className="text-black px-3 sm:px-4 py-1 rounded-lg bg-[#FF7D66] mb-2 text-sm sm:text-base">
